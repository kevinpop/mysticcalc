...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: data.title,
    description: data.metaDescription,
    url: "https://mysticcalc.com/feng-shui/tips",
  },
};

export default function FengShuiTipsPage() {
  return (
    <article className="prose prose-purple max-w-none">
      ...
      <h2>Essential Feng Shui Tips for Every Home</h2>
      <ul>
        {data.tips.map((tip, i) => (
          <li key={i}>{tip}</li>
        ))}
      ...
      <h2>Colors That Support Positive Energy</h2>
