...
const data = fengShuiData.colors;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: data.title,
    description: data.metaDescription,
    url: "https://mysticcalc.com/feng-shui/colors",
  },
};
...
export default function FengShuiColorsPage() {
  return (
    <article className="prose prose-purple max-w-none">
      ...
      <h2>Practical Tips for Using Feng Shui Colors</h2>
      <ul>
        {data.tips.map((tip, i) => (
          <li key={i}>{tip}</li>
        ))}
      ...
      <h2>Feng Shui Color Meanings &amp; The Five Elements</h2>
      <div className="not-prose grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 my-6">
